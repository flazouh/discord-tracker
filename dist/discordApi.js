    ...
    async executeWithRetry(operation, operationName) {
        ...
        for (let attempt = 0; attempt <= this.retryConfig.maxRetries; attempt++) {
            try {
                ...
                console.warn(`Discord API ${operationName} failed (attempt ${attempt + 1}/${this.retryConfig.maxRetries + 1}), ` +
        ...
        if (lastError.response) {
            ...
            throw TrackerError.discordApiError(`Discord API ${operationName} failed: No response received after ${this.retryConfig.maxRetries + 1} attempts. ` +
            ...
            throw TrackerError.discordApiError(`Discord API ${operationName} failed: Request setup error - ${lastError.message}. ` +
