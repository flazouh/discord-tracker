...
describe('MessageBuilder', () => {
  ...
  it('should build the step update embed correctly for a pending step', () => {
    ...
    const embed = buildStepUpdateEmbed(prNumber, prTitle, steps, currentStep, totalSteps);
  ...
  it('should build the completion embed correctly for a successful pipeline', () => {
    ...
    const embed = buildCompletionEmbed(prNumber, prTitle, steps, totalSteps, startTime);
