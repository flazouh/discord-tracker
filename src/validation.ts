 ...
 */
export function validateStepNumber(stepNumber: number, totalSteps: number): void {
  if (stepNumber <= 0) {
 ...
 */
export function validateAdditionalInfo(additionalInfo: string): Array<[string, string]> {
