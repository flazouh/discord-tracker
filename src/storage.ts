...
// Interface corresponding to Rust's PipelineState struct
...
/// Manages saving and loading pipeline state to a file
export class MessageStorage {
	...
	async loadPipelineState(): Promise<PipelineState | undefined> {
		try {
